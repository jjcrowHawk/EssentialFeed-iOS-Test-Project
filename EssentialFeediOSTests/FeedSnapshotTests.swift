...
//
//  Created by Macbook Pro on 26/9/23.
//
...
class FeedSnapshotTests: XCTestCase {
    ...
    private func feedWithContent() -> [ImageStub] {
        return [
            ImageStub(
                description: "The East Side Gallery is an open-air gallery in Berlin. It consists of a series of murals painted directly on a 1,316 m long remnant of the Berlin wall, located near the centre of Berlin, on Mühlenstraße in Friedrichshain-Kreuzbero. The gallery has official status as a Denkmal, or heritage-protected landmark.",
    ...
    private func assert(snapshot: UIImage, named name: String, file: StaticString = #file, line: UInt = #line) {
        ...
        let storedSnapshotData = makeSnapshotData(for: snapshot, file: file, line: line)
